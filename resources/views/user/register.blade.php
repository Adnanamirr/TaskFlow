            ...
            <div class="hidden md:block">
                ...
                @else
                    <div class="ml-3">
                        ...
                        <a href="{{ route('login') }}" class="{{Route::currentRouteName() === 'user.login' ? 'bg-gray-900 text-white' : 'text-gray-300' }} hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                            Log In
                        </a>
                    </div>
                @endauth
